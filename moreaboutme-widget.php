...
/*
  ...
  Plugin URI: http://wordpress.org/plugins/moreaboutme-widget
  Description: Displays an AboutMe bloc, including a picture and some text
  Version: 1.0
...
class moreaboutme_widget_Widget extends WP_Widget {
	...
	function moreaboutme_widget_Widget() {
		parent::WP_Widget(false, 'MoreAboutMe Widget', array('description' => 'Displays an AboutMe bloc, including a picture and some text'));
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('texte'); ?>"><?php _e('Text:'); ?> <textarea class="widefat" class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id('texte'); ?>" name="<?php echo $this->get_field_name('texte'); ?>"><?php echo $texte; ?></textarea></label></p>
		<p><input id="<?php echo $this->get_field_id('filter'); ?>" name="<?php echo $this->get_field_name('filter'); ?>" type="checkbox" <?php checked(isset($instance['filter']) ? $instance['filter'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('filter'); ?>"><?php _e('Automatically add paragraphs'); ?></label></p>
		<p><label for="<?php echo $this->get_field_id('imageurl'); ?>"><?php _e('Image Url:'); ?> <input class="widefat" id="<?php echo $this->get_field_id('imageurl'); ?>" name="<?php echo $this->get_field_name('imageurl'); ?>" type="text" value="<?php echo $imageurl; ?>" /></label></p>
<?php
	}
